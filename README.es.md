...
| **Build** | CI en verde (runners nativos, ~15 min/arq) · `bootc container lint` OK · 383 pruebas `vibed` en verde (+ 27 pruebas de la extensión Zed + 100 comprobaciones del cliente HUD) |
