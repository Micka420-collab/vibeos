...
| **Build** | CI en verde (runners nativos, ~15 min/arq) · `bootc container lint` OK · 346 pruebas `vibed` en verde (+ 17 pruebas de la extensión Zed + 73 comprobaciones del cliente HUD) |
