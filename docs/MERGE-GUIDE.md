# MERGE-GUIDE — 2 PR à merger dans `main`

> **But** : rapatrier dans `main` deux correctifs qui y sont absents. Ouvre ce
> fichier, merge les deux PR ci-dessous, c'est tout. Dernière vérif : 2026-07-14.
