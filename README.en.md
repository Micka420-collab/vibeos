...
| **Build** | Green CI (native runners, ~15 min/arch) · `bootc container lint` OK · 420 green `vibed` tests (+ 27 Zed extension tests + 100 HUD client checks) |
