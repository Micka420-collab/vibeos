...
| **Build** | Green CI (native runners, ~15 min/arch) · `bootc container lint` OK · 358 green `vibed` tests (+ 17 Zed extension tests + 73 HUD client checks) |
