...
| **Build** | Grüne CI (native Runner, ~15 min/Arch) · `bootc container lint` OK · 331 grüne `vibed`-Tests (+ 17 Tests der Zed-Erweiterung + 73 Prüfungen des HUD-Clients) |
