...
| **Build** | Grüne CI (native Runner, ~15 min/Arch) · `bootc container lint` OK · 467 grüne `vibed`-Tests (+ 27 Tests der Zed-Erweiterung + 100 Prüfungen des HUD-Clients) |
