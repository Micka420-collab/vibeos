...
**Après le boot**, une seule commande donne l'état réel du système (19 invariants : `vibed`, socket + permissions, politique fail-closed, denylist, chaîne d'audit, Genesis, racine en lecture seule, réglage noyau IA appliqué, mode d'exploitation) :
...
| **Build** | CI verte (runners natifs, ~15 min/arch) · `bootc container lint` OK · 340 tests `vibed` verts (+ 17 tests de l'extension Zed + 73 contrôles du client HUD) |
