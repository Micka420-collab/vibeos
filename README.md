...
| **Build** | CI verte (runners natifs, ~15 min/arch) · `bootc container lint` OK · 346 tests `vibed` verts (+ 17 tests de l'extension Zed + 73 contrôles du client HUD) |
