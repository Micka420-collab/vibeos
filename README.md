...
| **Build** | CI verte (runners natifs, ~15 min/arch) · `bootc container lint` OK · 395 tests `vibed` verts (+ 27 tests de l'extension Zed + 100 contrôles du client HUD) |
